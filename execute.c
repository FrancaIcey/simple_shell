...
/**
 * check_cdir - to check if ":" is present in the current directory.
...
/**
 * check_error_command - to verify if the user has permissions
...
/**
 * command_exec - to execute command lines.
...
/**
 * is_exec - to determine if a command is an executable.
 * @datashell: Data structure.
