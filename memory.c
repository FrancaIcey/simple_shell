...
/**
 * add_ln_nd_end - to add command line at the end of a line_list.
...
/**
 * free_line_ls - to free line_list.
 * @hd: Head of the linked list.
 * Return: No return.
 */
...
/**
 * add_node_en - to add a separator found at the end
 * of a sep_list.
 * @sp: Separator found (; | &).
 * Return: Address of the head.
 */
