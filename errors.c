#include "main.h"
/**
 * first_character - to find index of the first non-whitespace character.
 * @inp: intptr_t string.
...
/**
 * disp_syn_err - To display a syntax error message.
...
/**
 * ch_syn_err - to intermediate function to find and print a syntax error.
 * @data_sh: data structure.
...
/**
 * dupl_chars - to count repetitions of a character in a string.
 * @inp: intptr_t string.
 * @index: index.
...
/**
 * sep_oper_error - to find the syntax errors in the intptr_t string.
 * @inp: intptr_t string.
 * @index: index.
 * @lastchar: last character read.
 * Return: The index when there's error, and 0 when no error.
 */
