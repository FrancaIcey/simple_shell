...
/**
 * err_environ - to generate error message for env-related operations.
...
/**
 * err_path126 - to generate an error message for path-related
...
/**
 * conc_err_msg - to concatenate an error message for the 'cd' command.
