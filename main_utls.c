#include "main.h"
/**
 * get_err - to call the error message according to the
...
/**
 * empty_data - to free data structure.
...
/**
 * set_datashell - to initialize data structure
 * @data_shell: data structure
...
/**
 * get_hlp - to retrieve help messages
...
/**
 * get_bltn - to retrieve the function pointer of the builtin command
