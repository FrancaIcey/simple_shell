...
/**
 * _isdigit - to determine if a string consists only of numeric digits.
 * @str: The input string to be checked.
 * Return: 1 if the string consists only of numeric digits, or 0 otherwise.
 */
...
/**
 * _strdup - to duplicate a string in the heap memory.
...
/**
 * compare_chars - to compare string characters
...
/**
 * _strtok - to split a string by a specified delimiter.
