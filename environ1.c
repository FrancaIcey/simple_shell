#include "main.h"
/**
 * replace_str - To replace string into vars.
 * @inp: Input string.
...
/**
 * _unsetenv - To delete an environ variable with the specified name.
...
/**
 * set_env - To set an environment variable.
...
/**
 * _setenv - To compare env variables names
...
/**
 * cp_info - To copy information to create a new environment var or alias.
