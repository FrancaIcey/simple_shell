...
/*My team: Nontsikelelo Hewu, Fatiha Boutalount */
/**
 * get_environ - to get value of an environment variable.
...
/**
 * display_env - to print the environ vars.
...
/**
 * _getline - To read input from stream
