#include "main.h"
/**
 * _strspn - to calculate the length of the initial segment of a
 ...
 * @str1: Pointer to the first str to compare
 * @str2: Pointer to the second str to compare
...
/**
 * _strchr - to locate a character in str.
 * @str: Pointer to the string to search.
