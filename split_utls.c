...
/**
 * move_nxt - to move to next command line stored.
...
/**
 * swp_character - to swap '|' and '&' for non-printed characters
 * in a string.
 * @inp: Input string.
...
/**
 * add_nd - to add separators and command lines to lists.
...
/**
 * free_value_ls - To frees r_variable list.
